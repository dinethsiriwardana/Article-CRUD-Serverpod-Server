...
import 'package:mypod_server/src/generated/article_class.dart' as _i4;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    ...
    connectors['article'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'getArticals': _i1.MethodConnector(
          name: 'getArticals',
          params: {
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['article'] as _i2.ArticleEndpoint).getArticals(
            session,
